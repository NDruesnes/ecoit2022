 ...
 */
final class Version20220331162326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE instructor CHANGE is_verified is_verified TINYINT(1) NOT NULL');
    }
