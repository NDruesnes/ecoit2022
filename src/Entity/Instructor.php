...
class Instructor implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=InstructorStatut::class, inversedBy="instructors",cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Training::class, inversedBy="instructors")
     */
    private $trainings;
